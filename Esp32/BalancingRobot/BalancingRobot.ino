...
// -- Stepper motors
#define motEnablePin 26

#define reverseLeftMotor true
#define reverseRightMotor false

fastStepper motLeft(13, 12, 0, reverseLeftMotor, motLeftTimerFunction);
fastStepper motRight(14, 27, 1, reverseRightMotor, motRightTimerFunction);
